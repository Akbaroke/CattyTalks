...
export const createRoom = async (req, res) => {
  ...
  try {
    ...
    res
      .status(400)
      .json({ msg: "create room failed, please try again later." });
  }
};
...
export const checkDuplicateRoom = async (req, res) => {
  ...
  try {
    ...
    res
      .status(400)
      .json({ msg: "Check duplicate failed, please try again later." });
  }
};
...
export const checkRoomForJoin = async (req, res) => {
  ...
  try {
    ...
    if (qry1Room)
      return res.status(201).json({ msg: "this room is yours self." });
...
export const checkStatusRoom = async (req, res) => {
  ...
  try {
    ...
    if (!qryRoom)
      return res
        .status(201)
        .json({ msg: "This room has expired or been deleted." });
    ...
    res
      .status(400)
      .json({ msg: "get room status failed, please try again later." });
  }
};
